...
var lactoseIntolerent = false;
var nutAllergy = false;
var vegan = false;
...
function restrictListProducts(prods) {
	...
	if ( lactoseIntolerent ) {
		list = applyFilter( "lactose", list, true);
	}
	if ( nutAllergy ) {
		list = applyFilter( "nutAllergy", list, true);
	}
	if ( vegan ) {
		list = applyFilter( "vegan", list, true);
	}
	if ( glutenFree ) {
		list = applyFilter( "gluten", list, true);
	}
