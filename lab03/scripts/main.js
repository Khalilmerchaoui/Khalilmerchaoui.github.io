...
function populateListProductChoices( order ) {
    ...
    var optionArray = restrictListProducts(products.slice());
...
function selectedItems(){
	...
	c.appendChild(div);
	c.appendChild(document.createTextNode("Total Price is " + getTotalPrice(chosenProducts, quantityMap) + "$"));
